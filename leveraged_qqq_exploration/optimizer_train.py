# ==========================================================
# TRAINING-PERIOD OPTIMIZER  —  QQQ / QLD / TQQQ strategy
#
...
def plot_top_combos(df, results, n=5):
    ...
    ax.set_title("Top combos — training period 2003–2014 equity curves", fontsize=11)
...
def plot_scatter(results):
    ...
    ax.set_ylabel("CAGR (%)")
    ax.set_title("CAGR vs Worst Annual Return — training period 2003–2014")
...
if __name__ == "__main__":
    ...
    print(f"  Filter: year-end DD <= {DD_LIMIT*100:.0f}% from {DD_START_YEAR} onward")
    print("=" * 105)
